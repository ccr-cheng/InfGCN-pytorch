...
from .density import DensityDataset
from .small_density import SmallDensityDataset
...
class DensityCollator:
    ...
    def __call__(self, batch):
        ...
        if self.n_samples is None:
            ...
            grid_coord = pad_sequence(grid_coord, batch_first=True, padding_value=0.)
...
__all__ = [
    'get_dataset', 'register_dataset',
    'DensityDataset', 'SmallDensityDataset',
    'DensityCollator', 'DensityVoxelCollator'
]
